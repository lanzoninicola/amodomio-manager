    ...
    return (
        <>
            ...
            <div className="hidden peer-checked:block md:block">
                <div className="absolute top-[100%] left-0 h-[75vh] w-[95vw] md:w-[inherit] md:h-[inherit] bg-white flex justify-center flex-col md:flex-row md:bg-none md:relative">
                    {links.map((link) => (
